...
class __Mustache_f21882b7d944fb5b834e6e53b0741a9d extends Mustache_Template
{
...
';
        ...
        // 'isediting' section
        $value = $context->find('isediting');
        $buffer .= $this->section8384faf8de4cc05d6db91fa291768123($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        // 'isediting' section
        $value = $context->find('isediting');
        $buffer .= $this->section1ef3408629d667a55616d035678aee5a($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section8384faf8de4cc05d6db91fa291768123(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section1ef3408629d667a55616d035678aee5a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
