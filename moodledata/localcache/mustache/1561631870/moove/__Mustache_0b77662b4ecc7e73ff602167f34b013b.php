...
class __Mustache_0b77662b4ecc7e73ff602167f34b013b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE848377d7e3f14e676c43d2e3a769e0e($context, $indent, $value);
...
';
    ...
    private function sectionC34c16b656734fba0d2a0a65679f5b0c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEe5cc3d634940de1f2d59e568a827518(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC9f043d080e6f2d7214591a12b21ba39(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= '">
';
                $buffer .= $indent . '                                                    <img class="border rounded h-auto rounded-circle" src="';
...
';
    ...
    private function section65d62f08bf2de0def42547bcf91fa68f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionC9f043d080e6f2d7214591a12b21ba39($context, $indent, $value);
...
';
    ...
    private function section6170f5eba03e84f0659296165a8ba1e2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE3edd3cf08cb2a577755c1b0e93b40aa(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section65d62f08bf2de0def42547bcf91fa68f($context, $indent, $value);
                ...
                if (empty($value)) {
                    ...
                    // 'urls.userlist' section
                    $value = $context->findDot('urls.userlist');
                    $buffer .= $this->section6170f5eba03e84f0659296165a8ba1e2($context, $indent, $value);
                    // 'urls.userlist' inverted section
                    $value = $context->findDot('urls.userlist');
                    if (empty($value)) {
...
';
    ...
    private function sectionC3fb35af54dc1b50297398aded4c40ed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                <td scope="col" class="group">
';
                // 'discussion.group' section
                $value = $context->findDot('discussion.group');
                $buffer .= $this->sectionE3edd3cf08cb2a577755c1b0e93b40aa($context, $indent, $value);
                $buffer .= $indent . '                                </td>
';
                $context->pop();
            }
    ...
    private function sectionA423ec39b09b011a2a0ab97aaf13f677(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                                            <div class="p-3 w-100 h-100 d-block">
';
                $buffer .= $indent . '                                                <a href="';
...
';
    ...
    private function section26492380e0237c6b18e5c74c89e117ec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA423ec39b09b011a2a0ab97aaf13f677($context, $indent, $value);
...
';
    ...
    private function section22727e70e0202c5a545fe53beca20752(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                // 'forum.userstate.tracked' section
                $value = $context->findDot('forum.userstate.tracked');
                $buffer .= $this->section26492380e0237c6b18e5c74c89e117ec($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionFf1552e5197295a23a98906fafbcf58f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionB06c9196f7101ad8589e8c42e8282318(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6a6ed2c0d449b399ac40cd8584a2464a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionEe5cc3d634940de1f2d59e568a827518($context, $indent, $value);
                $buffer .= $indent . '                            </td>
';
                // 'forum.state.groupmode' section
                $value = $context->findDot('forum.state.groupmode');
                $buffer .= $this->sectionC3fb35af54dc1b50297398aded4c40ed($context, $indent, $value);
                // 'forum.capabilities.viewdiscussions' section
                $value = $context->findDot('forum.capabilities.viewdiscussions');
                $buffer .= $this->section22727e70e0202c5a545fe53beca20752($context, $indent, $value);
                $buffer .= $indent . '                            <td scope="col" class="text-left">
';
                // 'latestpostid' section
                $value = $context->find('latestpostid');
                $buffer .= $this->sectionFf1552e5197295a23a98906fafbcf58f($context, $indent, $value);
                $buffer .= $indent . '                            </td>
';
...
';
                // 'discussion' section
                $value = $context->find('discussion');
                $buffer .= $this->sectionB06c9196f7101ad8589e8c42e8282318($context, $indent, $value);
                $buffer .= $indent . '                            </td>
';
                $buffer .= $indent . '                        </tr>
';
...
';
    ...
    private function sectionE848377d7e3f14e676c43d2e3a769e0e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                        ...
                        $buffer .= $this->sectionC34c16b656734fba0d2a0a65679f5b0c($context, $indent, $value);
                        $buffer .= $indent . '                    </tr>
';
                        $buffer .= $indent . '                </thead>
';
...
';
                        ...
                        $buffer .= $this->section6a6ed2c0d449b399ac40cd8584a2464a($context, $indent, $value);
                        $buffer .= $indent . '                </tbody>
';
                    }
                    $buffer .= $indent . '            </table>
