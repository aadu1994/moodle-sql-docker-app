...
class __Mustache_ebd9399913b52aac31ecfda38ae4234d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section627c2fbd478601230bdabd1f190822df($context, $indent, $value);
    ...
    private function section627c2fbd478601230bdabd1f190822df(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="container-fluid frontpage-numbers">
        <div class="row">
            <div class="col-md-3">
                {{!Added by Zohaib Asim: Dated 19/6/2019
                            Custom Styling
                }}
                <h2 style="color: #000;"><p>{{#str}} frontpagenumbersome, theme_moove {{/str}}</p>{{#str}} frontpagenumbernumbers, theme_moove {{/str}}</h2>
            </div>
...
';
                $buffer .= $indent . '                <h2 style="color: #000;"><p>';
                // 'str' section
