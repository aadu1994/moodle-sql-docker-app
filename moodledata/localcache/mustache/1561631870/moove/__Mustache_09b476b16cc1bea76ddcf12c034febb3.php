...
class __Mustache_09b476b16cc1bea76ddcf12c034febb3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9813f1751bdb4cffdad14bdc72492a89($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= $this->section4eb02bf4a325729f03b58e2d262956dd($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'hasidentityproviders' section
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->sectionA661c67999654ad34331f111c625402b($context, $indent, $value);
        $buffer .= $indent . '
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionB7bf5f836d8b359d91c1c94f0a195db7($context, $indent, $value);
        }
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
...
';
        // 'cansignup' section
        $value = $context->find('cansignup');
        $buffer .= $this->section8bb34db00587fc097daaa33a388ada33($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function section9813f1751bdb4cffdad14bdc72492a89(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="row justify-content-center logo">
        {{! ID added by Zohaib Asim - Dated 26/6/2019}}
        <img id="img_custom" src="{{logourl}}" title="{{sitename}}" alt="{{sitename}}"/>
    </div>
';
...
';
                $buffer .= $indent . '        <img id="img_custom" src="';
...
';
    ...
    private function section4eb02bf4a325729f03b58e2d262956dd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="m-t-2">
                        ...
                        <form action="{{loginurl}}" method="post" id="guestlogin">
                            ...
                            {{! Custom Class(btn-secondary-custom) Added by Zohaib Asim - Dated 26/6/2019}}
                            <button class="btn btn-secondary-custom" type="submit">{{#str}}loginguest{{/str}}</button>
                        </form>
                    </div>
                ';
            $result = call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '                            
';
                $buffer .= $indent . '                            <button class="btn btn-secondary-custom" type="submit">';
                // 'str' section
                $value = $context->find('str');
...
';
    ...
    private function sectionFe2bbbb8ef0de70c226f3346ec613f95(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                            <div class="potentialidp">
                                <a href="{{{url}}}" title={{#quote}}{{name}}{{/quote}} class="btn btn-secondary-custom">
                                    {{#iconurl}}
                                        <img src="{{iconurl}}" alt="" width="24" height="24"/>
                                    {{/iconurl}}
                                    {{name}}
...
';
                ...
                $buffer .= ' class="btn btn-secondary-custom">
';
                // 'iconurl' section
...
';
    ...
    private function sectionA661c67999654ad34331f111c625402b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionFe2bbbb8ef0de70c226f3346ec613f95($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $context->pop();
            }
    ...
    private function sectionB7bf5f836d8b359d91c1c94f0a195db7(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section8bb34db00587fc097daaa33a388ada33(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
