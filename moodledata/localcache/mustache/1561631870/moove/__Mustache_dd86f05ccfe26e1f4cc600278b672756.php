...
class __Mustache_dd86f05ccfe26e1f4cc600278b672756 extends Mustache_Template
{
...
';
        // 'is_label' section
        $value = $context->find('is_label');
        $buffer .= $this->sectionB36ab27676573f3cb1b00ec2fef56ecb($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'is_label' inverted section
        $value = $context->find('is_label');
        if (empty($value)) {
            ...
            // 'useSubtiles' section
            $value = $context->find('useSubtiles');
            $buffer .= $this->sectionE794da3c76dd7efc61b6dd9ffb5c0106($context, $indent, $value);
            $buffer .= $indent . '
';
            // 'useSubtiles' inverted section
            $value = $context->find('useSubtiles');
...
';
                ...
                if (empty($value)) {
                    ...
                    // 'clickable' section
                    $value = $context->find('clickable');
                    $buffer .= $this->sectionC317a8f8a3b5f75ee55a84e06ee6802d($context, $indent, $value);
                    $buffer .= $indent . '
';
                    // 'clickable' inverted section
                    $value = $context->find('clickable');
                    if (empty($value)) {
                        ...
                        $buffer .= $indent . '                            <span class="editingactivity instancename">
';
...
';
    ...
    private function sectionB36ab27676573f3cb1b00ec2fef56ecb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    private function section2e4fac75f5fe26ab307242c685fd4ebf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $value;
                $buffer .= '/mod/resource/view.php?id=';
                $value = $this->resolveValue($context->find('cmid'), $context);
                $buffer .= $value;
                $buffer .= '" data-title="';
                $value = $this->resolveValue($context->find('modtitle'), $context);
...
';
    ...
    private function section2326db09149e7c629a4cc21913a9803b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section2e4fac75f5fe26ab307242c685fd4ebf($context, $indent, $value);
                $buffer .= $indent . '
';
...
';
    ...
    private function sectionE4fe89cadd0492996408728ae24cca6b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '<a class="clickable-region" href="{{url}}" data-action="launch-tiles-{{launchtype}}"></a>';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
...
';
    ...
    private function sectionE794da3c76dd7efc61b6dd9ffb5c0106(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                    // 'clickable' section
                    $value = $context->find('clickable');
                    $buffer .= $this->section2326db09149e7c629a4cc21913a9803b($context, $indent, $value);
                    // 'clickable' inverted section
                    $value = $context->find('clickable');
                    if (empty($value)) {
...
';
                    ...
                    // 'clickable' section
                    $value = $context->find('clickable');
                    $buffer .= $this->sectionE4fe89cadd0492996408728ae24cca6b($context, $indent, $value);
                    $buffer .= '
';
                }
                $buffer .= $indent . '
...
';
    ...
    private function section3e64e9990fc714b6d868742f9155492e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = ' {{#clickable}}{{#isEmbeddedResource}} data-action="launch-tiles-resource-modal"{{/isEmbeddedResource}}{{#isEmbeddedModule}}
                               data-action="launch-tiles-module-modal"{{/isEmbeddedModule}}{{/clickable}}';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
                $buffer .= $result;
            } else {
    ...
    private function sectionC317a8f8a3b5f75ee55a84e06ee6802d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                // 'clickable' section
                $value = $context->find('clickable');
                $buffer .= $this->section3e64e9990fc714b6d868742f9155492e($context, $indent, $value);
                $buffer .= '
';
                $buffer .= $indent . '                               data-title="';
                $value = $this->resolveValue($context->find('modtitle'), $context);
