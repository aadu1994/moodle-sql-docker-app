...
class __Mustache_3d5b3dcac13a7303275f0fe44a77817e extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            // 'from_ajax' section
            $value = $context->find('from_ajax');
            $buffer .= $this->sectionF0dd673b57248584da2f8baf88716b42($context, $indent, $value);
...
';
            ...
            $buffer .= $this->section097c2a52fd0a5cc623d3f356307d46ed($context, $indent, $value);
        }
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</li>';
...
';
    ...
    private function sectionF0dd673b57248584da2f8baf88716b42(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <div id="sectionbuttons">
';
...
';
    ...
    private function section097c2a52fd0a5cc623d3f356307d46ed(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
