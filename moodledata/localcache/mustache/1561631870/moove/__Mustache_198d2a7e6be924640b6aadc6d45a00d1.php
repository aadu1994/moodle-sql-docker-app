...
class __Mustache_198d2a7e6be924640b6aadc6d45a00d1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    .format-tiles .tag-info {
';
        $buffer .= $indent . '        background-color: ';
        $value = $this->resolveValue($context->find('base_colour'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
...
';
        ...
        $buffer .= $this->section6a3794b73162e2faef26f9bcb9359504($context, $indent, $value);
        $buffer .= $indent . '
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section29a7d188aa962fee323af44c8d1e241e($context, $indent, $value);
            $buffer .= $indent . '
';
...
';
    ...
    private function section6a3794b73162e2faef26f9bcb9359504(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section29a7d188aa962fee323af44c8d1e241e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '            .format-tiles.jsenabled li.tile,
';
                $buffer .= $indent . '            .format-tiles.jsenabled #section-0,
';
                $buffer .= $indent . '            .format-tiles.jsenabled ul.tiles .tile.tile-restricted,
';
                $buffer .= $indent . '            .format-tiles.jsenabled ul.tiles .tile.tile-hidden {
';
